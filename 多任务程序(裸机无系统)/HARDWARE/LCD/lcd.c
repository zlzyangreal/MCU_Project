		  ...
		  case MAIN_MODE1:
			{
				switch(Sys.Mode.Sub_MAIN_MODE1)
					...
					case MAINMODE1_SUBMODE1:
						...
						POINT_COLOR=BLACK; 
						LCD_ShowString(30,40,210,24,24,"Speed/RPM/Gear            "); 
						LCD_ShowString(0,70,240,16,16,"      Speed100km/h                      ");
					break;
					...
					case MAINMODE1_SUBMODE2:
						...
						POINT_COLOR=BLUE;
						LCD_ShowString(30,40,210,24,24,"Speed/RPM/Gear            "); 
						LCD_ShowString(0,70,240,16,16,"      Engine speed 200r/m                    ");
					break;
					...
					case MAINMODE1_SUBMODE3:
						...
						POINT_COLOR=BRED;
						LCD_ShowString(30,40,210,24,24,"Speed/RPM/Gear            "); 
						LCD_ShowString(0,70,240,16,16,"         gear3                            ");
					break; 
				  ...
				  switch(Sys.Mode.Sub_MAIN_MODE2)
					  {
							...
							case MAINMODE2_SUBMODE1:
								POINT_COLOR=BLACK;
								LCD_ShowString(30,40,210,24,24,"    Mileage           "); 
								LCD_ShowString(0,70,240,16,16,"    TotalMileage40000km              ");
							...
							case MAINMODE2_SUBMODE2:
								...
								POINT_COLOR=BLUE;
								LCD_ShowString(30,40,210,24,24,"    Mileage             "); 
								LCD_ShowString(0,70,240,16,16,"      FuelMileage500km               ");
							...
							case MAINMODE2_SUBMODE3:
								...
								POINT_COLOR=BRED;
								LCD_ShowString(30,40,210,24,24,"    Mileage            "); 
								LCD_ShowString(0,70,240,16,16,"     FueledMileage600km            ");
							break; 
							default:
					...
					switch(Sys.Mode.Sub_MAIN_MODE3)
						{
						 //子模式为MAINMODE2_SUBMODE1状态
							case MAINMODE3_SUBMODE1:
								POINT_COLOR=BLACK;
								LCD_ShowString(30,40,210,24,24,"   Temperature      "); 
								LCD_ShowString(0,70,240,16,16,"    WaterTemperature7Celsius       ");
							...
							case MAINMODE3_SUBMODE2:
								...
								POINT_COLOR=BLUE;
								LCD_ShowString(30,40,210,24,24,"   Temperature      "); 
								LCD_ShowString(0,70,240,16,16,"    InterTemperature8Celsius           ");
							...
							case MAINMODE3_SUBMODE3:
								...
								POINT_COLOR=BRED;
								LCD_ShowString(30,40,210,24,24,"   Temperature      "); 
								LCD_ShowString(0,70,240,16,16,"    OutdoorTemperature9Celsius       ");
							break; 
							default:
